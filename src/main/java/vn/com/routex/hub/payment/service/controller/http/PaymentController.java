...
import vn.com.routex.hub.payment.service.interfaces.models.payment.CheckoutResponse;
import vn.com.routex.hub.payment.service.interfaces.models.payment.CheckoutResponse.CheckoutResponseData;
import vn.com.routex.hub.payment.service.interfaces.models.payment.CreatePaymentSessionRequest;
import vn.com.routex.hub.payment.service.interfaces.models.payment.CreatePaymentSessionResponse;
import vn.com.routex.hub.payment.service.interfaces.models.payment.CreatePaymentSessionResponse.CreatePaymentSessionResponseData;
...
public class PaymentController {
    ...
    private CreatePaymentSessionResponse toCreatePaymentSessionResponse(CreatePaymentSessionResult result) {
        return CreatePaymentSessionResponse.builder()
                ...
                .data(CreatePaymentSessionResponseData.builder()
    ...
    private CheckoutResponse toCheckoutResponse(CheckoutResult result) {
        return CheckoutResponse.builder()
                .result(result.result())
                .data(CheckoutResponseData.builder()
                        .paymentId(result.paymentId())
                        .status(result.status())
                        .amount(result.amount())
                        .currency(result.currency())
